...
class movement:
    ...
    def launch(self):  # needs to run in while loop every .005 seconds
        ...
        thetaOffset = round(currentHeading - self.targetBearing, 0)  # targetHeading-currentHeading   #calculates theta offset (the difference between the heading and the direction of intention)
